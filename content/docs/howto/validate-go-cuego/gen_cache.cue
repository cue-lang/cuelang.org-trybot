			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "dZx2Wy7ZOBM1Rk7OqbOksl/nguyQBYXVpRG1EV9WZ7A="
							}
							multi_step: {
								hash:       "MCH63QLSSMERJ6G7QR1SJU2HB1F98615THK8LUMSDM8DGMBPOSRG===="
								scriptHash: "R7426HEVBD42PJROKPDDN7580A6GAT2H6MO2M0MF9A5RRD40NGDG===="
								steps: [{
									doc:      ""
