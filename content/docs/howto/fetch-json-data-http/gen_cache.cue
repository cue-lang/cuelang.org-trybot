			...
			howto: {
				"fetch-json-data-http": {
					page: {
						cache: {
							upload: {
								"HIDDEN: server.go": "KynhcrLO45R5CVSUY+rIr1zGNMNHX8i5u2d1toQNvwA="
								cc:                  "37MzMTp0EVm5EpvipHOS6SAO/G+JO69hX0J5cxOa1z8="
							}
							multi_step: {
								hash:       "5JRE6M1F51SF8BEQIFUMMUKS2FUG3D6PR3NONES8DG6CT1RGUP50===="
