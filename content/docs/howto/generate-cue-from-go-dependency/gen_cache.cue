			...
			howto: {
				"generate-cue-from-go-dependency": {
					page: {
						cache: {
							upload: {
								"deps.go":     "MJZ9oDizN/hN6H1SEIpm7ag2MKC0lR3Y+YgwEJZe2Sw="
								"example.cue": "u8M21mtvBCOh3bd5eg/8FVFmHclurIynr1/D5BzrgWs="
							}
							multi_step: {
								hash:       "M18LFPML93CS0IMR99ITSBLRAQBEK7OC75DNHLHP9UF8S1H9EU5G===="
